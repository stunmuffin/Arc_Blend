...
class mball_capsule (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.metaball_add(
            type='CAPSULE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class mball_plane (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.metaball_add(
            type='PLANE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class mball_ellipsoid (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.metaball_add(
            type='ELLIPSOID', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class mball_cube (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.metaball_add(
            type='CUBE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class empty_plain_axes (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.empty_add(
            type='PLAIN_AXES', radius=1, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class empty_single_arrow (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.empty_add(
            type='SINGLE_ARROW', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class empty_circle (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.empty_add(
            type='CIRCLE', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class empty_cube (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.empty_add(
            type='CUBE', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class empty_sphere (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.empty_add(
            type='SPHERE', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class empty_cone (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.empty_add(
            type='CONE', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class empty_image (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.empty_add(
            type='IMAGE', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class light_point (bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bpy.ops.object.light_add(
            type='POINT', radius=1, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
# ------------------------------------------------------------------------------
# LIGHT SUN BUTTON
...
class light_sun (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.light_add(
            type='SUN', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class light_spot (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.light_add(
            type='SPOT', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
# ------------------------------------------------------------------------------
# LIGHT AREA BUTTON
...
class light_area (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.light_add(
            type='AREA', align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class light_probe_cubemap (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.lightprobe_add(
            type='CUBEMAP', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
# ------------------------------------------------------------------------------
...
class light_probe_reflectionplane (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.lightprobe_add(
            type='PLANAR', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class light_probe_irradiencevolume (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.lightprobe_add(
            type='GRID', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class forcefield_force (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='FORCE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
# ------------------------------------------------------------------------------
...
class forcefield_wind (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='WIND', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class forcefield_vortex (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='VORTEX', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class forcefield_magnetic (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='MAGNET', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class forcefield_harmonic (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='HARMONIC', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class forcefield_charge (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='CHARGE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class forcefield_lennardj (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='LENNARDJ', enter_editmode=False, align='WORLD', location=(0, 0, 0))
        return {"FINISHED"}
...
class forcefield_texture (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='TEXTURE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class forcefield_curveguide (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='GUIDE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class forcefield_boid (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='BOID', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class forcefield_turbulance (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='TURBULENCE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class forcefield_drag (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.effector_add(
            type='DRAG', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class forcefield_fluidflow (bpy.types.Operator):
    """Add an empty object with a physics effector to the scene: Smoke Flow"""
    bl_label = "Smoke Flow"
    bl_idname = "object.button_forcefield_fluidflow"

    def execute(self, context):
        bpy.ops.object.effector_add(
            type='SMOKE', enter_editmode=False, align='WORLD', location=(0, 0, 0))
...
class collection_instance_collection (bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.ops.object.collection_instance_add(
            collection='Collection', align='WORLD', location=(0, 0, 0))
    ...
    def draw(self, context):
        ...
        if bpy.context.selected_objects != []:
            ...
            sub.prop(Arc_Blend, "align_objects_xyz",
                     text="Align Objects", icon="OUTLINER_OB_GROUP_INSTANCE")
    ...
    scatter_view_as: bpy.props.EnumProperty(
        ...
        items=[("arc_blend_scatter_as_none", "None", "None", "X", 1),
               ...
               ("arc_blend_scatter_as_collection", "Collection",
                "Scatter as Collection", "OUTLINER_OB_GROUP_INSTANCE", 4),
               ],
...
class display_panel (bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        scrn = bpy.data.screens[bpy.context.screen.name]
    ...
    def draw(self, context):
        ...
        if bpy.context.scene.Arc_Blend.modelling_cutter:
            ...
            if bpy.context.active_object!= None:
             ...
             row.operator("object.button_cutter_apply_modifier", text="", icon="PLAY" )
...
class cutter_box_object(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for k in range(0,leng):
            ...
            lenm = len(bpy.data.objects[bpy.context.active_object.name].modifiers)
            active_mod = bpy.data.objects[bpy.context.active_object.name].modifiers[k].name
            bpy.context.object.modifiers[active_mod].name = "AB_Cutter_Object"+ str(k)
            active_cutter = bpy.data.objects[bpy.context.active_object.name].modifiers[k].name
            ...
            bpy.context.object.modifiers["AB_Cutter_Object"+ str(k)].object = bpy.data.collections['AB_Cutters_Object'].objects[k]
            bpy.context.object.modifiers["AB_Cutter_Object"+ str(k)].object.color = (0.0517386, 0.70876, 1, 0.342857)
    ...
    def draw(self, context):
        ...
        try:
            if bpy.context.tool_settings.mesh_select_mode[0] and bpy.context.active_object.mode == "EDIT":
                ...
                row = layout.row(align=True)
                props = row.operator("mesh.rip_move", text="Rip Vertices", icon="STICKY_UVS_VERT")
                ...
                row.operator("object.button_vertex_selection_connect_vertex_path",
                             text="Connect Vertex Path", icon="OUTLINER_DATA_CURVE")
        ...
        try:
            ...
            if bpy.context.tool_settings.mesh_select_mode[1] and bpy.context.active_object.mode == "EDIT":
                ...
                row.operator("transform.edge_slide",
                             text="Edge Slide", icon="GP_MULTIFRAME_EDITING")
        ...
        try:
            if bpy.context.active_object.mode == "EDIT":
                ...
                row2.operator("object.button_modelling_edit_knife_cut",
                              text="Knife", icon="SCULPTMODE_HLT")
                ...
                row6.operator("mesh.bevel", text="Bevel",
                              icon="MOD_BEVEL")
                row6.operator("mesh.knife_project", text="Knife Project", icon="MESH_GRID")
                ...
                if bpy.context.scene.Arc_Blend.marks_edit_geometry == True:
                    ...
                    row.operator("mesh.mark_seam",
                                 icon="PARTICLE_PATH").clear = False
                    row.operator("mesh.mark_seam", text="Clear Seam",
                                 icon="PANEL_CLOSE").clear = True

                    row = box.row(align=True)
                    row.operator("mesh.mark_sharp", icon="MARKER")
                    ...
                    row.operator("mesh.mark_freestyle_edge",
                                 icon="FORCE_TURBULENCE").clear = False
                    row.operator("mesh.mark_freestyle_edge",
                                 text="Clear Freestyle Edge", icon="PANEL_CLOSE").clear = True
...
class Proxy_Panel (bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        rem.operator("object.button_proxy_panel_list_select_same_collection",
                     icon='OUTLINER_OB_GROUP_INSTANCE', text="")

        #
        rem = col2.column(align=True)
        rem.operator(
            "object.button_proxy_panel_list_apply_all_modifiers", icon='PLAY', text="")
...
class Scatter_Panel_Paint_Panel (bpy.types.Panel):
    ...
    def draw_header(self, context):
        ...
        layout.label(text="Paint Panel", icon="BRUSH_DATA")
...
class Scatter_Panel_Collection (bpy.types.Panel):
    ...
    def draw_header(self, context):
        ...
        layout.label(text="Collection", icon="OUTLINER_OB_GROUP_INSTANCE")
    ...
    def draw_header(self, context):
        ...
        try:
            ...
            layout.prop(part, "use_collection_count",
                        text="Proportion (Elements)", icon="OUTLINER_OB_GROUP_INSTANCE")
        except (TypeError, AttributeError, UnboundLocalError, KeyError):
            pass
